...
> Важно: на **одном хосте** публиковать **один и тот же** фиксированный порт (8085) на **нескольких репликах** невозможно. Поэтому для масштабирования на одном узле используйте вариант ниже.
